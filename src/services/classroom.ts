...
export const addReviewPoint = (classId: string, data: { idHomework: string, idStudent: string, currentPoint: number, pointReview: number, explain: string, title: string }) => {
...
export const finalizedPoint = (classId: string, postId: string, point: number) => {
    return api.patch(`${BASE_URL}${classId}/posts/${postId}`, {point})
}